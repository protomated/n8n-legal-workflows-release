...
1. Open your n8n canvas, press `Ctrl+V` (or `Cmd+V`), and paste the contents of [`pac-81-rules-based-intake-qualifier.json`](https://raw.githubusercontent.com/protomated/n8n-legal-workflows-release/main/workflows/pac-81-rules-based-intake-qualifier.json). Do not activate it yet.
